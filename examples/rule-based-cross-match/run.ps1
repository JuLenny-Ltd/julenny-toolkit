# rule-based-cross-match. Thin scenario bootstrap: names the scenario, then hands off to the
# shared _core driver. Which function (count or itemized) is picked at 00-init time, so one folder runs
...
#     <workdir>\samples\rule-based-cross-match\<data-owner or data-consumer>\
