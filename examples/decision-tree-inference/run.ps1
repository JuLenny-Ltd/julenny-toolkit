# decision-tree-inference. Thin scenario bootstrap: names the scenario, then hands off to the
...
#     <workdir>\samples\decision-tree-inference\<data-owner or data-consumer>\
